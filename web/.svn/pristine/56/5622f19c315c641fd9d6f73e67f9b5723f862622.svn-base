<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Redpacket_comment_list.aspx.cs" Inherits="Qrcms.Web.adminusers.Redpacket.Redpacket_comment_list" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="Redpacket_comment_add.aspx?action=<%=DTEnums.ActionEnum.Add %>&no=<%=no%>&goodid=<%=goodid%>"><i></i><span>新增</span></a></li>
                ...
                <ItemTemplate>
                    <tr>
                         <th align="center" style="width: 5%;">
                            ...
                            <th align="center" style="width: 5%;"><a href="Redpacket_comment_add.aspx?action=<%=DTEnums.ActionEnum.Edit%>&no=<%=no%>&goodid=<%=goodid%>&id=<%#Eval("id")%>">修改</th>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
