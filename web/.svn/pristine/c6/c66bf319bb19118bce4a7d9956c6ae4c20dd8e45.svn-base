<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="auction_order_list.aspx.cs" Inherits="Qrcms.Web.adminusers.auction.auction_order_list" %>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center"><%#(GetStatus(Convert.ToInt32(Eval("id"))))%></td>
