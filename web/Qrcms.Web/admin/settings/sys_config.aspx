<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="Qrcms.Web.admin.settings.sys_config" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>红包中奖率</dt>
                <dd>
                    <asp:TextBox ID="winrate" runat="server" CssClass="input normal" />
                    <span class="Validform_checktip">红包中奖率，0.01表示1%</span>
                </dd>
            </dl>
            <dl>
                <dt>提现手续费扣除金额</dt>
                <dd>
                    <asp:TextBox ID="withdraw_deposit" runat="server" CssClass="input normal" />
                    <span class="Validform_checktip">提现手续费扣除金额，单位（元）</span>
                </dd>
            </dl>
            <dl>
                <dt>充值手续费比例</dt>
                <dd>
                    <asp:TextBox ID="txtczsxfbl" runat="server" CssClass="input normal" />
                    <span class="Validform_checktip">用户充值时，会扣除相应比例的手续费。0.01表示1%</span>
                </dd>
            </dl>
            <dl>
                <dt>单件运费</dt>
                <dd>
                    <asp:TextBox ID="dj_freight" runat="server" CssClass="input normal" />
                    <span class="Validform_checktip">【运费配置位置-全局配置】单件商品的运费。</span>
                </dd>
            </dl>
            <dl>
                <dt>递增运费</dt>
                <dd>
                    <asp:TextBox ID="dz_freight" runat="server" CssClass="input normal" />
                    <span class="Validform_checktip">递增运费。运费=（数量-1）*递增运费+单件运费</span>
                </dd>
            </dl>
            <dl>
                <dt>服务费</dt>
                <dd>
                    <asp:TextBox ID="cover_charge" runat="server" CssClass="input normal" />
                    <span class="Validform_checktip">每笔订单的服务费</span>
                </dd>
            </dl>
            <dl>
                <dt>时时彩UID</dt>
                <dd>
                    <asp:TextBox ID="ssc_uid" runat="server" CssClass="input normal" />
                </dd>
            </dl>
            <dl>
                <dt>时时彩TOKEN</dt>
                <dd>
                    <asp:TextBox ID="ssc_token" runat="server" CssClass="input normal" />
                </dd>
            </dl>
            <dl>
                <dt>最高消费金额（元）</dt>
                <dd>
                    <asp:TextBox ID="TxtMaximumamount" runat="server" CssClass="input normal" />
                </dd>
            </dl>
            <dl>
                <dt>最高消费金额提示</dt>
                <dd>
                    <asp:TextBox ID="TxtMaximumamountremark" runat="server" CssClass="input normal" />
                </dd>
            </dl>
        </div>
        <!--/网站基本信息-->
        ...
        <div class="tab-content" style="display: none">
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">尚未申请？<a href="http://www.qwb365.com" target="_blank">请点击这里注册</a></span>
                </dd>
            </dl>
            <dl>
                <dt>短信API地址</dt>
            ...
            <dl>
                ...
                <dd>请不要使用系统默认账户test，因为它是公用的测试账号；<br />
                    ...
                    如果您尚未申请开通，<a href="http://www.qwb365.com" target="_blank">请点击这里注册</a>成功后填写您的用户名和密码均可正常使用。
                </dd>
            </dl>
        </div>
        <!--/手机短信设置-->
      ...
      <span class="Validform_checktip">*超过设定的文件大小不予上传，0不限制</span>
            ...
            <dl>
                <dt>视频上传大小</dt>
                <dd>
                    <asp:TextBox ID="videosize" runat="server" CssClass="input small" datatype="n" sucmsg=" " />
                    KB
      <span class="Validform_checktip">*超过设定的文件大小不予上传，0不限制</span>
                </dd>
            </dl>
