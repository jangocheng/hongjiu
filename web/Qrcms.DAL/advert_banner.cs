    ...
    public partial class advert_banner
    {
        ...
        public int Add(Model.advert_banner model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@file_path", SqlDbType.VarChar,255),
					new SqlParameter("@link_url", SqlDbType.VarChar,255),
            ...
            int maxid = DbHelperSQL.GetMaxID("id", databaseprefix + "advert_banner");
            if (maxid == null)
            {
                return 0;
            }
