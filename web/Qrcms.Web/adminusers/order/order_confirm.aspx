<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_confirm.aspx.cs" Inherits="Qrcms.Web.adminusers.order.order_confirm" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new Qrcms.BLL.express().GetTitle(Convert.ToInt32(Eval("express_id")))%></td>
