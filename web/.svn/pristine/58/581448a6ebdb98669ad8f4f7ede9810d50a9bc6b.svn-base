    ...
    public partial class adv_edit : Web.UI.ManagePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (action == DTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                ChkAdminLevel("advert_list", DTEnums.ActionEnum.Edit.ToString()); //检查权限
                if (!DoEdit(this.id))
                {
                ...
                JscriptMsg("修改成功！", "advert_list.aspx", "parent.loadMenuTree");
            }
            else //添加
            {
                ChkAdminLevel("advert_list", DTEnums.ActionEnum.Add.ToString()); //检查权限
                if (!DoAdd())
                {
                    JscriptMsg("保存过程中发生错误！", "");
                    return;
                }
                JscriptMsg("添加成功！", "advert_list.aspx", "parent.loadMenuTree");
            }
        }
