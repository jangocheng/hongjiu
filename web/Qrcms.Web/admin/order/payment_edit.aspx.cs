    ...
    public partial class payment_edit : Web.UI.ManagePage
    {
        ...
        private void ShowInfo(int _id)
        {
            ...
            else if (model.api_path.ToLower() == "weixinsmtwo")
            {
                ...
                txttwo_merNo.Text = doc.SelectSingleNode(@"Root/merNo").InnerText;
                txttwo_url.Text = doc.SelectSingleNode(@"Root/url").InnerText;
                txttwo_Key.Text = doc.SelectSingleNode(@"Root/Key").InnerText;
            }
            else if (model.api_path.ToLower() == "weixingzhzf")
            {
                XmlDocument doc = XmlHelper.LoadXmlDoc(Utils.GetMapPath(siteConfig.webpath + "xmlconfig/weixingzhzf.config"));
                txtgzh_merNo.Text = doc.SelectSingleNode(@"Root/merNo").InnerText;
                txtgzh_url.Text = doc.SelectSingleNode(@"Root/url").InnerText;
                txtgzh_Key.Text = doc.SelectSingleNode(@"Root/Key").InnerText;
            }
        }
        #endregion
        ...
        private bool DoEdit(int _id)
        {
            ...
            {
                string weixinsmFilePath = Utils.GetMapPath(siteConfig.webpath + "xmlconfig/weixinsmtwo.config");
                XmlHelper.UpdateNodeInnerText(weixinsmFilePath, @"Root/merNo", txttwo_merNo.Text);
                XmlHelper.UpdateNodeInnerText(weixinsmFilePath, @"Root/url", txttwo_url.Text);
                XmlHelper.UpdateNodeInnerText(weixinsmFilePath, @"Root/Key", txttwo_Key.Text);
            }
            else if (model.api_path.ToLower() == "weixingzhzf")
            {
                string weixinsmFilePath = Utils.GetMapPath(siteConfig.webpath + "xmlconfig/weixingzhzf.config");
                XmlHelper.UpdateNodeInnerText(weixinsmFilePath, @"Root/merNo", txtgzh_merNo.Text);
                XmlHelper.UpdateNodeInnerText(weixinsmFilePath, @"Root/url", txtgzh_url.Text);
                XmlHelper.UpdateNodeInnerText(weixinsmFilePath, @"Root/Key", txtgzh_Key.Text);
            }
            if (bll.Update(model))
            {
