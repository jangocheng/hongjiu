...
namespace Qrcms.Web.admin.settings
{
    public partial class sys_config : Web.UI.ManagePage
    {
        ...
        private void ShowInfo()
        {
            ...
            winrate.Text = model.winrate;
            withdraw_deposit.Text = model.withdraw_deposit;
            dj_freight.Text = model.dj_freight.ToString();
            dz_freight.Text = model.dz_freight.ToString();
            cover_charge.Text = model.cover_charge.ToString();
            ssc_uid.Text = model.ssc_uid;
            ssc_token.Text = model.ssc_token;
            TxtMaximumamount.Text = model.Maximumamount.ToString();
            TxtMaximumamountremark.Text = model.Maximumamountremark;
            ...
            txtczsxfbl.Text = model.czsxfbl.ToString();
        }
        #endregion
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                model.winrate = Utils.StrToDecimal(winrate.Text, 0).ToString("0.00");
                model.withdraw_deposit = Utils.StrToDecimal(withdraw_deposit.Text, 0).ToString();
                ...
                model.dj_freight = Utils.StrToDecimal(dj_freight.Text, 0);
                model.dz_freight = Utils.StrToDecimal(dz_freight.Text,0);
                model.cover_charge = Utils.StrToDecimal(cover_charge.Text, 0);
                model.ssc_uid = ssc_uid.Text.Trim();
                model.ssc_token = ssc_token.Text.Trim();
                model.Maximumamount = Utils.StrToDecimal(TxtMaximumamount.Text.Trim(),0);
                model.Maximumamountremark = TxtMaximumamountremark.Text.Trim();
                ...
                model.czsxfbl = Utils.ObjToDecimal(txtczsxfbl.Text, 0);
