...
{
    public partial class order_list : Web.UI.UsersPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind("id>0" + CombSqlTxt(this.status, this.payment_status, this.express_status, this.if_upgrade,this.starttime, this.endtime,this.keywords), "status asc,add_time desc,id desc");
            }
        }
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("order_list.aspx", "status={0}&payment_status={1}&express_status={2}&if_upgrade={3}&keywords={4}&page={5}&starttime={6}&endtime={7}",
                this.status.ToString(), this.payment_status.ToString(), this.express_status.ToString(), this.if_upgrade.ToString(), this.keywords, "__id__", this.starttime, this.endtime);
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("order_list.aspx", "status={0}&payment_status={1}&express_status={2}&if_upgrade={3}&keywords={4}&starttime={5}&endtime={6}",
                this.status.ToString(), this.payment_status.ToString(), this.express_status.ToString(), this.if_upgrade.ToString(), txtKeywords.Text, txtStartTime.Text, txtEndTime.Text));
        }
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("order_list.aspx", "status={0}&payment_status={1}&express_status={2}&if_upgrade={3}&keywords={4}&starttime={5}&endtime={6}",
                ddlStatus.SelectedValue, this.payment_status.ToString(), this.express_status.ToString(), this.if_upgrade.ToString(), this.keywords,this.starttime, this.endtime));
        }
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("order_list.aspx", "status={0}&payment_status={1}&express_status={2}&if_upgrade={3}&keywords={4}&starttime={5}&endtime={6}",
                this.status.ToString(), ddlPaymentStatus.SelectedValue, this.express_status.ToString(), this.if_upgrade.ToString(), this.keywords,this.starttime, this.endtime));
        }
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("order_list.aspx", "status={0}&payment_status={1}&express_status={2}&if_upgrade={3}&keywords={4}&starttime={5}&endtime={6}",
                this.status.ToString(), this.payment_status.ToString(), ddlExpressStatus.SelectedValue, this.if_upgrade.ToString(), this.keywords,this.starttime, this.endtime));
        }
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("order_list.aspx", "status={0}&payment_status={1}&express_status={2}&if_upgrade={3}&keywords={4}&starttime={5}&endtime={6}",
                this.status.ToString(), this.payment_status.ToString(), this.express_status.ToString(), ddlifupgrade.SelectedValue, this.keywords,this.starttime, this.endtime));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("user_list.aspx", "status={0}&payment_status={1}&express_status={2}&if_upgrade={3}&keywords={4}&starttime={5}&endtime={6}",
                this.status.ToString(), this.payment_status.ToString(), this.express_status.ToString(), this.if_upgrade.ToString(), this.keywords, this.starttime, this.endtime));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("order_list.aspx", "status={0}&payment_status={1}&express_status={2}&if_upgrade={3}&keywords={4}&starttime={5}&endtime={6}",
                this.status.ToString(), this.payment_status.ToString(), this.express_status.ToString(), this.if_upgrade.ToString(), this.keywords,this.starttime, this.endtime));
        }
