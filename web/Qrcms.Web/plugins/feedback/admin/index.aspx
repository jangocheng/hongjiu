<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Qrcms.Web.Plugin.Feedback.admin.index" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new Qrcms.BLL.channel_site().GetTitle(Eval("site_path").ToString())%></td>
