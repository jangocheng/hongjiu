...
{
    public partial class auction_comment_add : Web.UI.ManagePage
    {
        ...
        private void DoAdd()
        {
            ...
            if (bll.Add(model) > 0)
            {
                ...
                JscriptMsg("添加成功！", "auction_comment_list.aspx?no=" + this.no + "&goodid=" + this.goodid);
            }
            else
            {
        ...
        private void DoEdit()
        {
            ...
            if (bll.Update(model))
            {
                ...
                JscriptMsg("修改信息成功！", "auction_comment_list.aspx?no=" + this.no + "&goodid=" + this.goodid);
            }
            else
            {
