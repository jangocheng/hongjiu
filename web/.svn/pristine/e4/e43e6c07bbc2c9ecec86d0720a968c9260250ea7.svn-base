<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment_edit.aspx.cs" Inherits="Qrcms.Web.admin.order.payment_edit" ValidateRequest="false" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <%if (model.api_path.ToLower() == "alipaypc" || model.api_path.ToLower() == "alipaywap")
              { %>
            <dl>
                <dt>支付宝账号</dt>
                <dd>
            ...
            <dl>
                <dt>商户AppSecret</dt>
                <dd>
                    <asp:TextBox ID="TxtAppSecret" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*微信AppSecret</span>
                </dd>
            </dl>
            <dl>
                <dt>商户mechid</dt>
                <dd>
                    <asp:TextBox ID="Txtmechid" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*微信mechid商户号</span>
                </dd>
            </dl>
            <dl>
                <dt>商户mechkay</dt>
                <dd>
                    <asp:TextBox ID="Txtmechkay" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*微信mechkay商户密钥</span>
                </dd>
            </dl>
            <%}
            ...
            <dl>
                <dt>商户号</dt>
                <dd>
                    <asp:TextBox ID="txt_mch_id" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*微信快捷支付的商户号</span>
                </dd>
            </dl>
            ...
            <dl>
                <dt>商户密钥</dt>
                <dd>
                    <asp:TextBox ID="txt_key" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*商户密钥</span>
                </dd>
            </dl>
            ...
            <dl>
                <dt>接口请求地址</dt>
                <dd>
                    <asp:TextBox ID="txt_req_url" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>通知回调地址</dt>
                <dd>
                    <asp:TextBox ID="txt_notify_url" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*</span>
                </dd>
            </dl>
            ...
            <dl>
                <dt>版本号</dt>
                <dd>
                    <asp:TextBox ID="txt_version" runat="server" CssClass="input normal" datatype="*" sucmsg=" ">1.0</asp:TextBox>
                    <span class="Validform_checktip">*</span>
                </dd>
            </dl>
            <%}
            ...
            <dl>
                <dt>商户号</dt>
                <dd>
                    <asp:TextBox ID="TxtmerchantCode" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*微信快捷支付的商户号</span>
                </dd>
            </dl>
             <dl>
                <dt>商户名称</dt>
                <dd>
                    <asp:TextBox ID="Txtshmc" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*微信快捷支付的商户名称</span>
                </dd>
            </dl>
            <dl>
                <dt>商户密钥</dt>
                <dd>
                    <asp:TextBox ID="Txtkey" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*商户密钥</span>
                </dd>
            </dl>
            ...
            <dl>
                <dt>服务类型</dt>
                <dd>
                    <asp:TextBox ID="Txtservice" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*</span>
                </dd>
            </dl>
            <%} 
            ...
            <dl>
                <dt>商户号</dt>
                <dd>
                    <asp:TextBox ID="Txtmch_id" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*微信快捷支付的商户号</span>
                </dd>
            </dl>
             <dl>
                <dt>登录账号</dt>
                <dd>
                    <asp:TextBox ID="Txtmch_number" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>商户密钥</dt>
                <dd>
                    <asp:TextBox ID="Txtzf_key" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*商户密钥</span>
                </dd>
            </dl>
            <%} 
              else if (model.api_path.ToLower() == "weixinsmtwo")
              { %>%>
             <dl>
                <dt>商户号</dt>
                <dd>
                    <asp:TextBox ID="txttwo_merNo" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*微信快捷支付的商户号</span>
                </dd>
            </dl>
             <dl>
                <dt>支付接口</dt>
                <dd>
                    <asp:TextBox ID="txttwo_url" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*支付调用的API接口</span>
                </dd>
            </dl>
            <dl>
                <dt>商户密钥</dt>
                <dd>
                    <asp:TextBox ID="txttwo_Key" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*商户密钥</span>
                </dd>
            </dl>
            <%}
              else if (model.api_path.ToLower() == "weixingzhzf")
              { %>%>
             <dl>
                <dt>商户号</dt>
                <dd>
                    <asp:TextBox ID="txtgzh_merNo" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*微信快捷支付的商户号</span>
                </dd>
            </dl>
             <dl>
                <dt>支付接口</dt>
                <dd>
                    <asp:TextBox ID="txtgzh_url" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*支付调用的API接口</span>
                </dd>
            </dl>
            <dl>
                <dt>商户密钥</dt>
                <dd>
                    <asp:TextBox ID="txtgzh_Key" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*商户密钥</span>
                </dd>
            </dl>
             <%} %>
