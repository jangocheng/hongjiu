<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_audit.aspx.cs" Inherits="Qrcms.Web.adminusers.users.user_audit" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new Qrcms.BLL.user_groups().GetTitle(Convert.ToInt32(Eval("group_id")))%></td>
