...
namespace Qrcms.DAL
{
    ...
    public partial class user_groups
    {
        ...
        public int Add(Model.user_groups model)
        {
            ...
            strSql.Append("title,grade,upgrade_exp,amount,point,discount,is_default,is_upgrade,is_lock,is_QRcodestate)");
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@is_QRcodestate", SqlDbType.Int,4)
                                        };
            ...
            parameters[9].Value = model.is_QRcodestate;
        ...
        public bool Update(Model.user_groups model)
        {
            ...
            strSql.Append("is_QRcodestate=@is_QRcodestate");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@title", SqlDbType.NVarChar,100),
					new SqlParameter("@grade", SqlDbType.Int,4),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id,title,grade,upgrade_exp,amount,point,discount,is_default,is_upgrade,is_lock,is_QRcodestate");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,title,grade,upgrade_exp,amount,point,discount,is_default,is_upgrade,is_lock,is_QRcodestate ");
            strSql.Append(" FROM " + databaseprefix + "user_groups ");
            if (strWhere.Trim() != "")
            {
        ...
        public Model.user_groups DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["is_QRcodestate"] != null && row["is_QRcodestate"].ToString() != "")
                {
                    model.is_QRcodestate = int.Parse(row["is_QRcodestate"].ToString());
                }
            }
            return model;
        }
