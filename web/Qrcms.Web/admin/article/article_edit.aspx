<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_edit.aspx.cs" Inherits="Qrcms.Web.admin.article.article_edit" ValidateRequest="false" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                ...
                <dd>
                    <div class="rule-multi-radio">
                        <asp:RadioButtonList ID="rblisupgrade" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" RepeatLayout="Flow" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged">
            ...
            <dl runat="server" id="ifShow" visible="false">
                <dt>选择大升级</dt>
                <dd>
                    <div class="rule-single-select">
                        <asp:DropDownList ID="ddlCategoryDXJ" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
                    </div>
                </dd>
            </dl>
            <dl runat="server" id="ifShowTwo" visible="false">
                <dt>中奖提款比例</dt>
                <dd>
                    <asp:TextBox ID="txtzjtkbl" runat="server" CssClass="input normal" sucmsg=" " />
                    <span class="Validform_checktip">中奖之后用户提款获得奖金比例。 奖金= 比例 * 订单金额 + 订单金额 。0.01表示1%</span>
                </dd>
            </dl>
            <dl>
                <dt>显示状态</dt>
