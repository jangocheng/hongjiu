...
namespace Qrcms.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        protected string get_filed(string channel_name,string filed, string strwhere)
        {
            return new BLL.article().GetFiled(channel_name, filed, strwhere);
        }
        #endregion
        ...
        public string get_order_article_title(int id)
        {
            return new BLL.orders().GetArticleTitle(id);
        }
    }
}
