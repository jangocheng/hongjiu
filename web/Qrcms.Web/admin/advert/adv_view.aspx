<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adv_view.aspx.cs" Inherits="Qrcms.Web.admin.adv_view" %>
...
<div class="content-tab-wrap">
  <div id="floatHead" class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a href="javascript:;" onclick="tabs(this);" class="selected">调用广告</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="tab-content">
  ...
  <dl>
    <dt>调用代码</dt>
    <dd>
      <textarea id="txtCopyUrl" class="input" runat ="server"  style="vertical-align:middle;width:800px;height:300px;"></textarea>
