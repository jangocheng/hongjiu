...
namespace Qrcms.DAL
{
    ...
    public partial class article
    {
            ...
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        strSql.Append("channel_id,category_id,call_index,title,link_url,img_url,seo_title,seo_keywords,seo_description,tags,zhaiyao,content,sort_id,click,status,is_msg,is_top,is_red,is_hot,is_slide,is_sys,user_name,add_time,update_time,is_upgrade,big_upgrade,zjtkbl)");
                        ...
                        SqlParameter[] parameters = {
                                ...
                                new SqlParameter("@is_upgrade",SqlDbType.Int,1),
                                new SqlParameter("@big_upgrade",SqlDbType.NVarChar,100),
                                new SqlParameter("@zjtkbl", SqlDbType.Decimal,2)
                                                    };
                        ...
                        parameters[24].Value = model.is_upgrade;
                        parameters[25].Value = model.big_upgrade;
                        parameters[26].Value = model.zjtkbl;
            ...
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        strSql.Append("big_upgrade=@big_upgrade,");
                        strSql.Append("zjtkbl=@zjtkbl");
                        strSql.Append(" where id=@id");
                        SqlParameter[] parameters = {
                                new SqlParameter("@channel_id", SqlDbType.Int,4),
                                new SqlParameter("@category_id", SqlDbType.Int,4),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id,channel_id,category_id,call_index,title,link_url,img_url,seo_title,seo_keywords,seo_description,tags,zhaiyao,content,sort_id,click,status,is_msg,is_top,is_red,is_hot,is_slide,is_sys,user_name,add_time,update_time,is_upgrade,big_upgrade,zjtkbl");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,channel_id,category_id,call_index,title,link_url,img_url,seo_title,seo_keywords,seo_description,tags,zhaiyao,content,sort_id,click,status,is_msg,is_top,is_red,is_hot,is_slide,is_sys,user_name,add_time,update_time,zjtkbl ");
            strSql.Append(" FROM " + databaseprefix + "article ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataTable GetListDT(int is_upgrade)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,channel_id,category_id,title ");
            strSql.Append(" from " + databaseprefix + "article");
            strSql.Append(" where is_upgrade=" + is_upgrade + " order by id asc ");
        ...
        private Model.article DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["big_upgrade"] != null && row["big_upgrade"].ToString() != "")
                {
                    model.big_upgrade = row["big_upgrade"].ToString();
                }
                if (row["zjtkbl"] != null && row["zjtkbl"].ToString() != "")
                {
                    model.zjtkbl = decimal.Parse(row["zjtkbl"].ToString());
                }
        ...
        public string GetFiled(string channel_name, string filed, string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
