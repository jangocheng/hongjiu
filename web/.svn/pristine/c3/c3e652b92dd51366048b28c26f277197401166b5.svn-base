<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_edit.aspx.cs" Inherits="Qrcms.Web.admin.users.user_edit" ValidateRequest="false" %>
...
<div class="tab-content">
  ...
  <dl>
    ...
    <dd><asp:TextBox ID="txtAddress" runat="server" CssClass="input normal"></asp:TextBox></dd>
      ...
      <dl>
    <dt>我的上级</dt>
    <dd><asp:TextBox ID="Txtsj" runat="server" CssClass="input normal"></asp:TextBox></dd>
  </dl>
      <dl>
   <%-- <dt>推广二维码</dt>
    <dd>
