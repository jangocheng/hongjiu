...
namespace Qrcms.Web.admin.users
{
    public partial class user_edit : Web.UI.ManagePage
    {
        ...
        private void ShowInfo(int _id)
        {
            ...
            //RBQRcode.SelectedValue = model.QRcodestate.ToString();
            //查找最近登录信息
        ...
        private bool DoAdd()
        {
            ...
            model.parent_user = Utils.DropHTML(Txtsj.Text.Trim());
            ...
            //model.QRcodestate = Utils.DropHTML(RBQRcode.SelectedValue);
            if (bll.Add(model) > 0)
            {
