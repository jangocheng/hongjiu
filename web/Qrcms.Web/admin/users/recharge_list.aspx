<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="recharge_list.aspx.cs" Inherits="Qrcms.Web.admin.users.recharge_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
            ...
            <asp:Repeater ID="rptList" runat="server">
                <HeaderTemplate>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                        <tr>
                            ...
                            <th align="left" width="10%">入金通道</th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%#new Qrcms.BLL.payment().GetTitle(Convert.ToInt32(Eval("payment_id")))%></td>
                        <td><%# Convert.ToDecimal(Eval("amount")) > 0 ? "+" + Eval("amount").ToString() : Eval("amount").ToString()%></td>
                        <td><%# Convert.ToDecimal(Eval("amount"))  > 0&&Convert.ToInt32(Eval("status")) == 1 ?  Convert.ToString(decimal.Round((Convert.ToDecimal(Eval("amount"))/(decimal)0.99 -Convert.ToDecimal(Eval("amount"))),2)) :"无"%></td>
        ...
        <div class="tab-content">
            金额汇总：<asp:Label ID="lblperformance" ForeColor="Red" runat="server" Text="0.00"></asp:Label>&nbsp;元&nbsp;&nbsp;&nbsp;
        </div>
        <!--内容底部-->
