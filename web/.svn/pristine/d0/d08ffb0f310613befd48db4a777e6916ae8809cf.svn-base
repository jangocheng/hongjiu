<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_list.aspx.cs" Inherits="Qrcms.Web.admin.article.article_list" %>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><%#new Qrcms.BLL.article_category().GetTitle(Convert.ToInt32(Eval("category_id")))%></td>
