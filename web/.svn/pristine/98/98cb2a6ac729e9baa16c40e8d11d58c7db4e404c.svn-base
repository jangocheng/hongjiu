...
namespace Qrcms.Web.api.payment.weixingzhzf
{
    public partial class notify_url : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            s.Close();
            s.Dispose();
            pageHelper.WriteLog("==============weixingzhzf=======" + builder.ToString());
            callback();
        }

        public void callback()
        {
            pageHelper.WriteLog("==============weixingzhzf=======");
            ...
            pageHelper.WriteLog("++++++++++gzhczcz+++++++++++" + signIn);
            string signtext = "amount=" + amount + "&bankType=" + bankType + "&channelFlag=" + channelFlag + "&currency=" + currency + "&extraDesc=" + extraDesc + "&goodsName=" + goodsName + "&merNo=" + merNo + "&notifyTime=" + notifyTime + "&orderNo=" + orderNo + "&outOrderNo=" + outOrderNo + "&payTime=" + payTime + "&reqId=" + reqId + "&transId=" + transId + "&uuid=" + uuidNew;//签名
