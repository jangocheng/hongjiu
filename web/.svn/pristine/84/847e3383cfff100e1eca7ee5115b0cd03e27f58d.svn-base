...
namespace Qrcms.Model
{
    ...
    public partial class orders
    {
        ...
        private int _quiz = 0;
        private string _auction_no = string.Empty;
        private int _quiz_result = 0;
        private string _order_user = string.Empty;
        private decimal _performance = 0M;
        private decimal _cover_charge = 0M;
        private decimal _order_zjtkbl = 0M;
        public DateTime? quiz_time { get; set; }
        ...
        {
            get { return _auction_no; }
            set { _auction_no = value; }
        }
        /// <summary>
        /// 竞猜结果
        /// </summary>
        public int quiz_result
        {
            get { return _quiz_result; }
            set { _quiz_result = value; }
        }
        /// <summary>
        /// 上级用户
        /// </summary>
        ...
        {
            get { return _order_user; }
            set { _order_user = value; }
        }
        /// <summary>
        /// 业绩
        /// </summary>
        ...
        /// 中奖提款比例
        /// </summary>
        public decimal order_zjtkbl
        {
            get { return _order_zjtkbl; }
            set { _order_zjtkbl = value; }
        }
        #endregion Model
