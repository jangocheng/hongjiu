<%@ Page Language="C#" AutoEventWireup="true" Inherits="Qrcms.Web.Plugin.Feedback.feedback" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Qrcms Template Engine at 2015/5/3 14:45:05.
		本页面代码由Qrcms模板引擎生成于 2015/5/3 14:45:05. 
	*/
	...
	DataTable list = new Qrcms.Web.Plugin.Feedback.feedback().get_feedback_list(10, page, "", out totalcount);

	string pagelist = get_page_link(10, page, totalcount, "mfeedback", "__id__");
