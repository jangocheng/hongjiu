...
{
    public partial class group_edit : Web.UI.UsersPage
    {
        ...
        private void ShowInfo(int _id)
        {
            ...
            RBQRcode.SelectedValue = model.is_QRcodestate.ToString();
        }
        #endregion
        ...
        private bool DoAdd()
        {
            ...
            model.is_QRcodestate = int.Parse(RBQRcode.SelectedValue);
            if (bll.Add(model) > 0)
            {
