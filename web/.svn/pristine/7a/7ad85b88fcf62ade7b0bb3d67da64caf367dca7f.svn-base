    ...
    public partial class advert
    {
        ...
        public int Add(Model.advert model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@target", SqlDbType.VarChar,30),
            ...
            object obj = DbHelperSQL.Exists(strSql.ToString(), parameters);
            int maxid = DbHelperSQL.GetMaxID("id", databaseprefix + "advert");
            if (maxid == null)
            {
                return 0;
            }
