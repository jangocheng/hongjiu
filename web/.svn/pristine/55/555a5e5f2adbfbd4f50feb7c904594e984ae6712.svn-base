...
{
    public partial class order_confirm : Web.UI.UsersPage
    {
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("order_confirm_page_size", "QrcmsPage"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("order_confirm_page_size", "QrcmsPage", _pagesize.ToString(), 14400);
                }
            }
