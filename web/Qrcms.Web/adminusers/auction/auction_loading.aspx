<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="auction_loading.aspx.cs" Inherits="Qrcms.Web.adminusers.auction.auction_loading" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="auction_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
