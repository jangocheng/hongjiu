<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mail_template_edit.aspx.cs" Inherits="Qrcms.Web.adminusers.users.mail_template_edit" ValidateRequest="false" %>
