...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string strWhere=" Order_type=1 and user_id="+userModel.id;
	if(status!=0)
	{
	...
	string pagelist = get_page_link(10, page, totalcount,"/mobile/upgrade_record.aspx?status="+status+"&page=__id__");
	...
	templateBuilder.Append("\r\n<span class=\"dfh\" style=\"background:#d09644\">\r\n");
	if (Utils.ObjectToStr(dr["quiz"])=="1")
	{

	templateBuilder.Append("\r\n鸡\r\n");
	}	//end for if

	if (Utils.ObjectToStr(dr["quiz"])=="2")
	{
	...
	if (Utils.ObjectToStr(dr["auction_no"])!="")
	{

	templateBuilder.Append("\r\n                                                    <span>幸运时刻：<i>" + Utils.ObjectToStr(dr["auction_no"]) + "</i></span>\r\n                                                    ");
	}	//end for if
