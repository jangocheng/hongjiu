    ...
    public partial class usercenter : Web.UI.UserPage
    {
        ...
        protected override void InitPage()
        {
            ...
            if (action == "exit")
            {
                ...
                //清除Cookies
                Utils.WriteCookie(DTKeys.COOKIE_USER_NAME_REMEMBER, "Qrcms", -43200);
                Utils.WriteCookie(DTKeys.COOKIE_USER_PWD_REMEMBER, "Qrcms", -43200);
                Utils.WriteCookie("UserName", "Qrcms", -1);
                Utils.WriteCookie("Password", "Qrcms", -1);
                //自动登录,跳转URL
