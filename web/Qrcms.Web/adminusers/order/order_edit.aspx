<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_edit.aspx.cs" Inherits="Qrcms.Web.adminusers.order.order_edit" ValidateRequest="false" %>
  ...
  <dl>
    ...
    <dd>
      <div class="table-container">
        ...
        <tr>
          <th>配送方式</th>
          <td><%=new Qrcms.BLL.express().GetTitle(model.express_id) %></td>
        </tr>
        <tr>
          <th>物流单号</th>
