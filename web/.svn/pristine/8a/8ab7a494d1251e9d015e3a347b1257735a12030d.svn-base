<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Redpacket_edit.aspx.cs" Inherits="Qrcms.Web.adminusers.Redpacket.Redpacket_edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            <dl>
                <dt>商品名称</dt>
                <dd>
                    <input type="hidden" id="good_id" value="" runat="server" onchange="javascript:GetInfo();" />
                    <asp:TextBox ID="name" runat="server" CssClass="input normal" datatype="*2-100" sucmsg=" "></asp:TextBox>
                    <input type="button" id="select" value="选择商品" class="btn" style="padding: 0 7px; color: black; background-color: transparent; border: 1px solid #eee" />
                </dd>
            </dl>
            <dl>
                <dt>商品图片</dt>
                <dd>
                    <asp:TextBox ID="goodimg" runat="server" CssClass="input normal upload-path" datatype="*2-100" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>封面图</dt>
                <dd>
                    <asp:TextBox ID="banner" runat="server" CssClass="input normal upload-path"></asp:TextBox>
                    <div class="upload-box upload-img"></div>
                </dd>
            </dl>
            <dl>
        ...
        <div class="tab-content" style="display: none;">
            <dl>
                <dt>销售价</dt>
                <dd>
                    <asp:TextBox ID="saleprice" runat="server" CssClass="input normal" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" "></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>浮动比例</dt>
                <dd>
                    <asp:TextBox ID="float_num" runat="server" CssClass="input normal" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                <dt>最高价</dt>
                <dd>
                    <asp:TextBox ID="highprice" runat="server" CssClass="input normal" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" "></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>最低价</dt>
                <dd>
                    <asp:TextBox ID="lowprice" runat="server" CssClass="input normal" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" "></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>截止时间</dt>
                <dd>
                    <asp:TextBox ID="endtime" runat="server" CssClass="input rule-date-input" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'%y-%M-%d %H:%m:%s'})" datatype="/^\s*$|^\d{4}\-\d{1,2}\-\d{1,2} \d{1,2}:\d{1,2}:\d{1,2}$/" errormsg="请选择正确的日期" sucmsg=" " />
                </dd>
            </dl>
            <dl>
                <dt>描述</dt>
